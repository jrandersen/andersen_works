...
## A New Data Standardization Frontier in AEC
...
### Challenges and Considerations
    ...
    **Industry Adoption:** Convincing the entire AECO industry to adopt new standards is a significant challenge, given the existing investment in current systems and practices. This sounds like a huge problem, but remeber and end user of a browser does need to know stanadrds of web stack to gain from it. The people affected in this are the existing Saas companies and anyone wanting to build new software and provide valeu to the artictes, engineers and contractors that run buisness building things.
    **Technical Complexity:** The multifaceted nature of construction projects adds layers of complexity to standardizing BIM data. This is reall challengs and is where hring teh right teams makes so much of a difference. On a spectrum of people whom know construction but not software building, to people whom know software building but not construction, a good mix is a diversity of people across it.
