...
Once that was all figured out we used multiple airtable bases to house different levels of information from models and combine it with other data sets like standard pricing, or standard site delivery items.
