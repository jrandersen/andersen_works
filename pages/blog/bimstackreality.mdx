...
Another innovator in this arena is NVDIA in their product Omniverse, which uses a language formed at Pixar called <a href="https://www.nvidia.com/en-us/omniverse/usd/" target="_blank">Universal Sceen Description</a> USD. In all honesty this seems to be a combonationation of a universal data structure and a universal display layer. USD has attributes for geometry, data, but also of rendering and visualization, materials, etc which one would expect for where it comes from. NVDIA has put signifigant effort to courting AEC technology professionals and some implemantations of it are imperssive and show value.   

The ongoing development of universal data languages and tools like those offered by Speckle Systems & NVDIA is vital for the future of BIM. It promises a more seamless, efficient, and collaborative approach to building design and construction, where data interoperability is no longer a barrier but a facilitator of progress. The concerted efforts of established companies, non-profit organizations like Building Smart, and innovative startups like Speckle Systems are collectively shaping a more integrated and efficient future for the AECO industry. Through their varied approaches, they are addressing the critical need for standardized, interoperable data languages in BIM, paving the way for enhanced collaboration and innovation in building design and construction.
...
Resources:
- [Data pools as the foundation for the smart buildings of the future](https://blog.siemens.com/2023/06/data-pools-as-the-foundation-for-the-smart-buildings-of-the-future/)
- [Creating A Common Data Language for Building Energy Performance](https://www.energy.gov/eere/buildings/articles/bedes-creating-common-data-language-building-energy-performance)
- [Creating a universal language fro city data](https://archinect.com/news/article/101167408/creating-a-universal-language-for-city-data)
- [Why the majority of data projects fail: the case for a Universal Data Language](https://medium.com/mlearning-ai/why-the-majority-of-data-projects-fail-the-case-for-a-universal-data-language-ee48164adc3a)
- [Why CRE Needs a Universal Data Language Now More Than Ever](https://www.globest.com/2019/05/15/why-the-industry-needs-a-universal-data-language-now-more-than-ever)
---
